...
namespace GameGraphics
{
    ...
    public class Sprite
    {
         ...
         * 
         * @param sprite The image that the sprite will use
         * @param type The type of sprite (like Ship, Planet)
         */
         ...
         * @param bounds The region of the screen the sprite will be drawn at
         * @param color Changes the color of the sprite
         * @param rotation The amount to rotate the sprite in radians
         * @param origin The point on the sprite that is used as the center of rotation
         * @param effect Chosen sprite mirroring option (like None, FlipHorizontally)
         * @param layer Represents the depth 0 front of layer 1 back of layer
         * @param action Integer representing what "action" of the sprite to display
         * @param frame Integer representing what "frame" of the action animation to display
         */
         ...
         * 
         * @param spriteBatch Contains graphics contexts for rendering on the game screen
         * @param x The left-right/west-east location of the sprite
         * @param y The up-down/north-south location of the sprite
         ...
         * 
         * @param sprite The image that will be used for the sprite
         */
         ...
         * 
         * @param type The type of object this sprite is used for
         */
