...
namespace Comp4432_AGP
{
    class Sprite
    {
         ...
         * frame: Integer representing what "frame" of the action animation to display
         */
        public void Render(SpriteBatch spriteBatch, int x, int y, int radius, float rotation, float layer, int action, int frame)
        {
            ...
            this.Render(spriteBatch, bounds, Color.White, rotation, origin, SpriteEffects.None, layer, action, frame);
        }// Render
