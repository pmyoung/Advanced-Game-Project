...
namespace GameGraphics
{
    ...
    /// 
    /// </summary>
    public abstract class AbstractGraphicEntity
    {
        ...
        /// 
        /// </summary>
        public static Color[] COLOR = { Color.White, Color.LightCoral, Color.LightBlue, Color.Lime, Color.Yellow, Color.Cyan, Color.Orange, Color.MediumPurple, Color.Pink };
        ...
        public AbstractGraphicEntity(float x, float y, float radius, float angle, int spriteID, int colorID)
        {
            this.SetX(x);
            this.SetY(y);
        ...
        ///<param name="angle">the angle of the object</param>
        ///<param name="spriteID">the ID of the sprite the object uses</param>
        public AbstractGraphicEntity(float x, float y, float radius, float angle, int spriteID)
        {
            this.SetX(x);
            this.SetY(y);
            this.SetRadius(radius);
        ...
        public AbstractGraphicEntity(float x, float y, float radius, float angle, int spriteID, Color color)
        {
            this.SetX(x);
            this.SetY(y);
            this.SetRadius(radius);
